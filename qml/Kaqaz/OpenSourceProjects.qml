...
Item {
    ...
    ListView {
        ...
        Component.onCompleted: {
            ...
            model.append({"title": "SialanQtTools", "license": "GNU GPL v3", "link": "https://github.com/sialan-labs/sialan-qt-tools", "description": "Some tools, creating for Sialan Qt projects and used on many of Sialan's projects"})
