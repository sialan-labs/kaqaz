...
#ifndef SIALANSENSORS_H
#define SIALANSENSORS_H

#include <QObject>

class SialanSensorsPrivate;
class SialanSensors : public QObject
{
    Q_OBJECT
...
public:
    SialanSensors(QObject *parent = 0);
    ~SialanSensors();
...
private:
    SialanSensorsPrivate *p;
};

#endif // SIALANSENSORS_H
