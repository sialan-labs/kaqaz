...
namespace qmapcontrol
{
    ...
    public:
        ...
        /*!
         * If this component doesnŽt have the image a network query gets started to load it.
         ...
         * @param host the proxyŽs hostname or ip
         * @param port the proxyŽs port
         * @param username the proxyŽs username
         * @param password the proxyŽs password
         */
